                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $clubPages = [
                                            "Занятие по танцам" => "teacher_dance.php",
                                            "Занятие по вышиванию" => "/clubs/chess.php",
                                            "Занятие по рисованию" => "teacher_painting.php",
                                            "Занятия по хоровой деятельности" => "teacher_choir.php",
                                            "Занятие по гитаре" => "teacher_guitar.php",
                                        ];
