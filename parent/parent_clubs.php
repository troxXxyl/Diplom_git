            ...
            <div class="col animate-fade-in delay-1">
                <div class="card club-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="parent_dance.php" class="btn btn-primary-custom mt-3">
            ...
            <div class="col animate-fade-in delay-1">
                <div class="card club-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="parent_choir.php" class="btn btn-primary-custom mt-3">
                            <i class="bi bi-arrow-right me-1"></i>Подробнее
                        </a>
                    </div>
                </div>
            ...
            <div class="col animate-fade-in delay-2">
                <div class="card club-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="parent_painting.php" class="btn btn-primary-custom mt-3">
                            <i class="bi bi-arrow-right me-1"></i>Подробнее
                        </a>
                    </div>
                </div>
            ...
            <div class="col animate-fade-in delay-2">
                <div class="card club-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="parent_guitar.php" class="btn btn-primary-custom mt-3">
                            <i class="bi bi-arrow-right me-1"></i>Подробнее
                        </a>
                    </div>
                </div>
