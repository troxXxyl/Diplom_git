...
<body>
        ...
        <header class="hero">
            <div class="container">
                <div class="hero-content animate-fade-in">
                    <h1 class="display-4 fw-bold mb-3">Кружок хоровой деятельности</h1>
                    <p class="lead mb-4">Развитие вокального мастерства и ансамблевого пения</p>
                </div>
            </div>
        </header>
    </div>
    ...
    <div class="container my-5">
        ...
        <div class="content-card animate-fade-in delay-1">
            <h2 class="mb-4"><i class="bi bi-mic text-primary me-2"></i>О кружке</h2>
            <p class="mb-0">Кружок хоровой деятельности приглашает всех, кто любит музыку и пение. Участники изучают основы вокальной техники, гармонии и ансамблевого исполнения. В программе — репетиции, выступления на концертах и участие в конкурсах.</p>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-4 text-center mb-4 mb-md-0">
                    <div class="teacher-photo">
                        <img src="/upload/teachers/choir_teacher.jpg" alt="Плутова Екатерина Дмитриевна" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-8">
                    <h3 class="h4">Плутова Екатерина Дмитриевна</h3>
                    <p>Опытный дирижёр и вокальный педагог с более чем 15-летним стажем. Её ученики неоднократно становились лауреатами региональных и международных конкурсов.</p>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM schedule WHERE subject = 'Занятия по хоровой деятельности'";
