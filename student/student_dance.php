...
<body>
        ...
        <header class="hero">
            <div class="container">
                <div class="hero-content text-center animate-fade-in">
                    <h1 class="display-4 fw-bold mb-3">Кружок по танцам</h1>
                    <p class="lead mb-4">Развиваем пластику и чувство ритма через танец</p>
                </div>
            </div>
        </header>
    </div>
    ...
    <div class="container my-5">
        <div class="d-flex justify-content-center gap-3 mb-5 animate-fade-in delay-1">
            ...
            <a href="student_clubs.php" class="btn btn-primary-custom">
                <i class="bi bi-people me-2"></i>Все секции
            </a>
        </div>

        <div class="content-card animate-fade-in delay-1">
            <h2 class="mb-4"><i class="bi bi-music-note-beamed text-primary me-2"></i>О кружке</h2>
            <p class="mb-0">Кружок по танцам предлагает занятия для всех возрастов и уровней подготовки. Учащиеся изучают различные танцевальные стили, такие как классический, современный, латиноамериканский и многие другие. Основное внимание уделяется развитию техники, музыкальности и выразительности.</p>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-4 text-center mb-4 mb-md-0">
                    <div class="teacher-photo">
                        <img src="/upload/teachers/dance_teacher.jpg" alt="Иванов Иван Иванович" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-8">
                    <h3 class="h4">Иванов Иван Иванович</h3>
                    <p>Профессиональный хореограф с 10-летним опытом преподавания. Он участвовал в многочисленных международных конкурсах и мастер-классах, а также является автором нескольких танцевальных постановок.</p>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM schedule WHERE subject = 'Занятия по танцам'";
