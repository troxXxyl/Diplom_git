    ...
    <main class="container my-5">
        <div class="row g-2 mb-2 justify-content-center">
            <div class="col-md-3 col-6 animate-fade-in delay-1">
                <a href="student_raspisanie.php" class="btn btn-primary-custom w-100 py-3 d-flex flex-column align-items-center">
                    <i class="bi bi-calendar-week fs-3 mb-2"></i>
                    <span>Расписание</span>
                </a>
            </div>
            <div class="col-md-3 col-6 animate-fade-in delay-1">
                <a href="student_clubs.php" class="btn btn-primary-custom w-100 py-3 d-flex flex-column align-items-center">
