                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $clubPages = [
                                            "Занятие по танцам" => "student_dance.php",
                                            "Занятие по вышиванию" => "/clubs/chess.php",
                                            "Занятие по рисованию" => "student_painting.php",
                                            "Занятия по хоровой деятельности" => "student_choir.php",
                                            "Занятие по гитаре" => "student_guitar.php",
                                        ];
