...
<body>
        ...
        <header class="hero">
            <div class="container">
                <div class="hero-content text-center animate-fade-in">
                    <h1 class="display-4 fw-bold mb-3">Секция по гитаре</h1>
                    <p class="lead mb-4">Искусство игры на шести струнах</p>
                </div>
            </div>
        </header>
    </div>
    ...
    <div class="container my-5">
        ...
        <div class="content-card animate-fade-in delay-1">
            <h2 class="mb-4"><i class="bi bi-music-note text-primary me-2"></i>О секции</h2>
            <p class="mb-0">Секция по гитаре предлагает обучение игре на инструменте для начинающих и опытных музыкантов. Учащиеся изучают аккорды, технику игры, а также исполняют музыкальные произведения разных жанров.</p>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-4 text-center mb-4 mb-md-0">
                    <div class="teacher-photo">
                        <img src="/upload/teachers/kopikina_elena.jpg" alt="Копейкина Елена Васильевна" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-8">
                    <h3 class="h4">Копейкина Елена Васильевна</h3>
                    <p>Опытный гитарист и преподаватель, более 15 лет выступающий на сцене. Она обучает студентов не только технике игры, но и музыкальной теории и интерпретации произведений.</p>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM schedule WHERE subject = 'Занятие по гитаре'";
